...
public:
    ...
    // Take ownership of an Open Telemetry connector. Must be set to enable value forwarding.
    virtual void setConnector(CTxOpenTelemetryConnector* connector);
...
private:
    IEspContext& context; /// source of the currently active Open Telemetry span
...
public:
    CTxOpenTelemetryConnector(IEspContext& context);
};
